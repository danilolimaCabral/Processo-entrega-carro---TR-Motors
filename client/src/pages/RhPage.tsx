      ...
      <Card>
        <CardContent className="p-4 space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_auto_auto] gap-3">
            <Input placeholder="Título do cargo" value={title} onChange={(e) => setTitle(e.target.value)} />
            <Input placeholder="Salário mín." value={salaryMin} onChange={(e) => setSalaryMin(e.target.value)} type="number" />
    ...
    <div className="space-y-4">
      <Card>
        <CardContent className="p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_auto_auto_auto] gap-3 items-end">
            <div className="space-y-1.5">
      ...
      <Card>
        <CardContent className="p-4 space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-[2fr_auto_auto] gap-3 items-end">
            <Input placeholder="Nome do feriado" value={name} onChange={(e) => setName(e.target.value)} />
            <Input type="date" value={date} onChange={(e) => setDate(e.target.value)} />
            <Button onClick={handleCreate} disabled={createMutation.isPending} size="sm"><Plus size={16} /> Adicionar</Button>
          </div>
        </CardContent>
      </Card>
